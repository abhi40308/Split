...
contract Split {
    ...
    function createGroup(bytes32 _name, address[] calldata _users, address _token, uint256 _timeout) external {
    ...
    function closeGroup(bytes32 _name, uint256[] calldata _amounts, bool[] calldata _isCredits, uint256 _timestamp, uint8[] calldata _vs, bytes32[] calldata _rs, bytes32[] calldata _ss) external {
    ...
    function updateGroup(bytes32 _name, uint256[] memory _amounts, bool[] memory _isCredits, uint256 _timestamp, uint8[] memory _vs, bytes32[] memory _rs, bytes32[] memory _ss) public {
    ...
    function _updateState(bytes32 _name, uint256[] memory _amounts, bool[] memory _isCredits, uint256 _timestamp) internal returns(bool) {
        uint256 credits;
        uint256 debits;
    ...
    function checkSigs(bytes32 _name, uint256[] memory _amounts, bool[] memory _isCredits, uint256 _timestamp, uint8[] memory _vs, bytes32[] memory _rs, bytes32[] memory _ss) public view returns(bool) {
    ...
    function checkSig(bytes32 _name, address _user, uint256[] memory _amounts, bool[] memory _isCredits, uint256 _timestamp, uint8 _v, bytes32 _r, bytes32 _s) public view returns(bool) {
    ...
    function _getHash2(bytes32 _name, uint256[] memory _amounts, bool[] memory _isCredits, uint256 _timestamp) internal view returns(bytes32) {
    ...
    function _getHash3(bytes32 _name, uint256[] memory _amounts, bool[] memory _isCredits, uint256 _timestamp) internal view returns(bytes32) {
    ...
    function _getHash4(bytes32 _name, uint256[] memory _amounts, bool[] memory _isCredits, uint256 _timestamp) internal view returns(bytes32) {
